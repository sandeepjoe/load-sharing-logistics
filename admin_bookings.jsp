		...
		<div class="fix single_blog_content_container">
                ...
                <td width="205"><div align="center"><span class="style3"><b><font color="#0ca3dc">Status</b></span></div></td>
                    ...
                    <%
                        ...
                        try 
                        {
                        String query1="select * from bookings where status = 'accepted'"; 
...
%>
		...
		<h2><i class="fa fa-bars"></i> Menu</h2>
                ...
                <div class="fix home_sidebar_top_apps">
                <h3><a href="admin_users.jsp">View Users</a></h3>
                </div>
                <div class="fix home_sidebar_top_apps">
                <h3><a href="admin_logs.jsp">View Logistics</a></h3>
		</div>
                <div class="fix home_sidebar_top_apps">
		<h3><a href="admin_bookings.jsp"><font color="red">View Bookings</a></h3>
                </div>
                <div class="fix home_sidebar_top_apps">
