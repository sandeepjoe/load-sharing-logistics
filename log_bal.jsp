...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		...
		<div class="fix single_blog_content_container">
                ...
                <h2><i class="fa fa-hand-o-down"></i> View Balances Kg's <a href="" class="floatright"> <i class="fa fa-angle-double-right"></i></a></h2>
                ...
                <td width="140" height="32"><div align="center"><span class="style3"><b><font color="#0ca3dc">KG's Remaining</b> </span></div></td>
                    </tr>
                    ...
                    <%
                        ...
                        try 
                        {
                        String query1="select * from route where logname = '"+user+"' "; 
                ...
                %>
                  ...
                  <td height="29"><div align="center"><%=rs.getInt("kgs")%></div></td>
                      </tr>
